...
*[class-methods.clojure](src/class_methods/clojure.clj)* *`make run-class-methods`*
```clojure
...
*[companion_objects.clojure](src/companion_objects/clojure.clj)* *`make run-companion-object`*
```clojure
